      ...
      <div className="fixed top-0 right-0 w-full bg-white text-black shadow-md">
        ...
        <div className="container py-3 sm:py-0">
          <div className="flex justify-between items-center">
            ...
            {/*book now button */}
            <div>
              <button className="bg-gradient-to-r from-primary to-secondary hover:bg-bg-gradient-to-r hover:from-secondary hover:bg-primary transition-all duration-1000 text-white px-3 py-1 rounded-full">
                Book Now
              </button>
